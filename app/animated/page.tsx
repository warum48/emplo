  ...
  return (
    ...
    "
      >
        ...
        <div className={` transition-grid grid grid-cols-1 gap-0 
             ${resultState ? 'md:grid-cols-1' : 'md:grid-cols-1'}`}>
        <div className='col-span-1'>

        <main
          className={`  
         ${resultState ? 'w-1/3' : 'w-full'} 
         transition-grid
      ...
      bg-opacity-70
        ...
        <Button onClick={()=> {setResultState(!resultState)}}>switch view</Button>
        <Footer />
