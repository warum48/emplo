...
const Settings = () => {
  return (
    <DashBoardPageContainer header="Создать резюме">
      ...
      <div className="absolute scale-y-150 left-0 top-0 right-0 bottom-0 
          bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-cyan-200/50 via-cyan-300/0 to-blue-600/0
          ...
          <div className="absolute -right-[150px] top-1/5 w-1/2 h-1/2 ">
      <div className="absolute scale-y-150 left-0 top-0 right-0 bottom-0 
     ...
     bg-white dark:text-white dark:bg-customGray-950/85 max-w-screen-lg rounded-2xl
     "
      >
