...
const Settings = () => {
  ...
  return (
    <DashBoardPageContainer header="Создать резюме" Icon={IconRobot} >
      <div className="flex flex-col items-center w-full ">
        ...
        <div className="absolute right-[150px] top-0 w-1/2 h-[400px] ">
          ...
          dark:bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] dark:from-pink-500/15 dark:via-pink-700/0 dark:to-pink-600/0
          "
          ></div>
        </div>
        </div>
