...
import { TitleLabel, TextInfo, CardPreTitle, CardTitle } from '@/components/__atoms/TextBlocks/TextBlocks'; // Adjust the import path as necessary
...
<CardExpandButton expanded={expanded} setExpanded={setExpanded} showWhenCollapsed={false} />
  ...
  <div className="space-y-1">
    ...
    <div>
      <TitleLabel>Candidate ID:</TitleLabel> <TextInfo>{employee.candidate_id}</TextInfo>
    </div>
    <div>
    ...
    <div>
      <TitleLabel>Gender:</TitleLabel> <TextInfo>{employee.gender}</TextInfo>
    </div>
    <div>
      <TitleLabel>Birth Date:</TitleLabel> <TextInfo>{employee.birth_date}</TextInfo>
    </div>
    <div>
      <TitleLabel>Alternate URL:</TitleLabel> <TextInfo>{employee.alternate_url}</TextInfo>
    </div>
    <div>
      <TitleLabel>Area:</TitleLabel> <TextInfo>{employee.area}</TextInfo>
    </div>
    <div>
      <TitleLabel>Business Trip Readiness:</TitleLabel> <TextInfo>{employee.business_trip_readiness}</TextInfo>
    </div>
    <div>
        ...
        {employee?.experience?.map((exp, index) => (
          <li key={index}>
            <div className="ml-4">
              ...
              <div>
                <TitleLabel>Company ID:</TitleLabel> <TextInfo>{exp?.company_id}</TextInfo>
              </div>
              <div>
              ...
              <div>
                ...
                <ul className="ml-4 space-y-2">
                  {exp?.industries?.map((industry) => (
                    <li key={industry?.id}>
                      <TitleLabel>ID:</TitleLabel> <TextInfo>{industry?.id}</TextInfo> <TitleLabel>Name:</TitleLabel> <TextInfo>{industry?.name}</TextInfo>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div>
                <TitleLabel>Company URL:</TitleLabel> <TextInfo>{exp?.company_url}</TextInfo>
              </div>
              <div>
                <TitleLabel>Employer:</TitleLabel>
                <div className="ml-4">
                  <div>
                    <TitleLabel>ID:</TitleLabel> <TextInfo>{exp?.employer?.id}</TextInfo>
                  </div>
                  <div>
                    <TitleLabel>Name:</TitleLabel> <TextInfo>{exp?.employer?.name}</TextInfo>
                  </div>
                  <div>
                    <TitleLabel>URL:</TitleLabel> <TextInfo>{exp?.employer?.url}</TextInfo>
                  </div>
                  <div>
                    <TitleLabel>Alternate URL:</TitleLabel> <TextInfo>{exp?.employer?.alternate_url}</TextInfo>
                  </div>
                  <div>
                    <TitleLabel>Logo URL:</TitleLabel> <TextInfo>{exp?.employer?.logo_urls?.['90']}</TextInfo>
                  </div>
                </div>
              </div>
              <div>
              ...
              <div>
                <TitleLabel>Description:</TitleLabel> <TextInfo>{exp?.description}</TextInfo>
              </div>
            </div>
          </li>
        ))}
